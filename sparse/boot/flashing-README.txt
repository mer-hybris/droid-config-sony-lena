= SAILFISH X FOR SONY XPERIA™ 10 III FLASHING GUIDE =

= FOR LINUX, WINDOWS AND OS X =

= STEP 1: GETTING AN XPERIA™ 10 III =

Get an Xperia™ 10 III. To be able to replace the Sony Android
...
The best way to get an unlockable device is to buy is a brand new Xperia™ 10 III
...
website and select the model of your device Xperia™ 10 III.
